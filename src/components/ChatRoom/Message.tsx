const Message = () => {
  return (
    <div className="flex gap-4 px-4 py-1 hover:bg-primary6">
      <div className="h-10 w-10 flex-shrink-0 cursor-pointer rounded-[50%] bg-primary1" />
      <div className="flex flex-col">
        <div className="flex items-end gap-4">
          <span className="cursor-pointer font-bold text-text3">User Name</span>
